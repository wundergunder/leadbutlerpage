        ...
        <div className="flex flex-col md:flex-row justify-between gap-8 pb-8 border-b border-slate-700">
          <div className="md:w-1/3">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=61576623923395" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-white transition-colors">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.instagram.com/leadbutlerteam/" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-white transition-colors">
              ...
              <a href="https://www.linkedin.com/company/lead-butler-team" target="_blank" rel="noopener noreferrer" className="text-slate-300 hover:text-white transition-colors">
