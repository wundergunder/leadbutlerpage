...
const Vik: React.FC = () => {
  useEffect(() => {
    ...
    script.setAttribute('data-widget-id', '682cf22123e5460ba7511866');
    script.async = true;
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600">
              Experience how Lead Butler could enhance guest communication at VIK Hotel
            </p>
          </div>

          <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-12">
            <img 
              src="https://storage.googleapis.com/msgsndr/f3n00M2vZx6xlPD7wdA2/media/682cf1967ae79b34a3da60d1.png"
              alt="VIK Hotel luxury view" 
              className="w-full h-64 object-cover"
            />
            <div className="p-8">
              <div className="flex items-center mb-6">
                <Hotel className="w-6 h-6 text-blue-600 mr-3" />
                <h2 className="text-2xl font-semibold text-slate-800">About VIK Hotel</h2>
              </div>
              <p className="text-slate-600 mb-6">
                VIK Hotel is a stunning luxury retreat that combines exceptional hospitality with world-class wine experiences. Set in a breathtaking location, the hotel offers unique accommodations, gourmet dining, and an immersive wine tourism experience that celebrates the rich viticultural heritage of the region.
              </p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            ...
            <div className="bg-blue-50 rounded-lg p-6 border border-blue-100 space-y-4">
              <p className="text-blue-800">
                <strong>👋 Test the Chatbot:</strong> Ask about wine tastings, vineyard tours, room amenities, or any other questions you might have about VIK Hotel.
              </p>
