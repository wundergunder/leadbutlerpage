...
const Santuario: React.FC = () => {
  useEffect(() => {
    ...
    script.setAttribute('data-widget-id', '682d1b5e2337d98174a71101');
    script.async = true;
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600">
              Experience how Lead Butler could enhance guest communication at Santuario
            </p>
          </div>

          <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-12">
            <img 
              src="https://storage.googleapis.com/msgsndr/f3n00M2vZx6xlPD7wdA2/media/682d1b0ce7803d18b40cbbd7.png"
              alt="Santuario luxury view" 
              className="w-full h-64 object-cover"
            />
            <div className="p-8">
              <div className="flex items-center mb-6">
                <Hotel className="w-6 h-6 text-blue-600 mr-3" />
                <h2 className="text-2xl font-semibold text-slate-800">About Santuario</h2>
              </div>
              <p className="text-slate-600 mb-6">
                Santuario is a luxurious retreat that offers a unique blend of comfort, style, and exceptional service. With its stunning architecture and attention to detail, the property provides guests with an unforgettable experience in a serene setting.
              </p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            ...
            <div className="bg-blue-50 rounded-lg p-6 border border-blue-100 space-y-4">
              <p className="text-blue-800">
                <strong>👋 Test the Chatbot:</strong> Ask about accommodations, amenities, experiences, or any other questions you might have about Santuario.
              </p>
