...
const Sendero: React.FC = () => {
  useEffect(() => {
    ...
    script.setAttribute('data-widget-id', '682b7fc9e4bd8461c92b4315');
    script.async = true;
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600">
              Experience how Lead Butler could enhance guest communication at Sendero Nosara
            </p>
          </div>

          <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-12">
            <img 
              src="https://storage.googleapis.com/msgsndr/f3n00M2vZx6xlPD7wdA2/media/682b7bf465f9d7433dfc8339.png"
              alt="Sendero Nosara aerial view" 
              className="w-full h-64 object-cover"
            />
            <div className="p-8">
              <div className="flex items-center mb-6">
                <Hotel className="w-6 h-6 text-blue-600 mr-3" />
                <h2 className="text-2xl font-semibold text-slate-800">About Sendero Nosara</h2>
              </div>
              <p className="text-slate-600 mb-6">
                Sendero Nosara is a boutique eco-hotel nestled in the heart of Nosara, Costa Rica. This sustainable luxury retreat combines world-class surfing, yoga, and wellness experiences with stunning ocean views and jungle surroundings.
              </p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            ...
            <div className="bg-blue-50 rounded-lg p-6 border border-blue-100 space-y-4">
              <p className="text-blue-800">
                <strong>👋 Test the Chatbot:</strong> Ask about surfing lessons, yoga classes, wellness experiences, or any other questions you might have about Sendero Nosara.
              </p>
