...
const Esencia: React.FC = () => {
  useEffect(() => {
    ...
    script.setAttribute('data-widget-id', '682c9dfcc9a5d137d4b1a9e1');
    script.async = true;
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600">
              Experience how Lead Butler could enhance guest communication at Hotel Esencia
            </p>
          </div>

          <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-12">
            <img 
              src="https://storage.googleapis.com/msgsndr/f3n00M2vZx6xlPD7wdA2/media/682c9ca3e8d710bb4ce2e230.jpeg"
              alt="Hotel Esencia luxury view" 
              className="w-full h-64 object-cover"
            />
            <div className="p-8">
              <div className="flex items-center mb-6">
                <Hotel className="w-6 h-6 text-blue-600 mr-3" />
                <h2 className="text-2xl font-semibold text-slate-800">About Hotel Esencia</h2>
              </div>
              <p className="text-slate-600 mb-6">
                Hotel Esencia is an award-winning luxury resort nestled on a secluded beach of the Riviera Maya. Originally built as the private hideaway home of an Italian duchess, this 50-acre estate features 45 suites and villas and offers world-class spa services, exceptional dining experiences, and personalized luxury service.
              </p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 mb-12">
            ...
            <div className="bg-blue-50 rounded-lg p-6 border border-blue-100 space-y-4">
              <p className="text-blue-800">
                <strong>👋 Test the Chatbot:</strong> Ask about spa services, dining options, beach activities, or any other questions you might have about Hotel Esencia.
              </p>
